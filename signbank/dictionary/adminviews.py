...
class GlossListView(ListView):
    ...
    def get_queryset(self):
        ...
        fieldnames = ['handedness', 'strong_handshape', 'weak_handshape', 'location', 'relation_between_articulators',
                      ...
                      'iconic_image', 'named_entity', 'semantic_field', 'number_of_occurences', 'fingerspelling', 'locatable']
        ...
        for topic in ['morphology', 'phonology', 'semantics', 'frequency', 'examples']:
            ...
            for field in fields[topic]:
                ...
                if field in ['phonology_other', 'mouth_gesture', 'mouthing', 'phonetic_variation', 'iconic_image']:
                    kind = 'text'
                elif field in ['repeated_movement', 'alternating_movement', 'fingerspelling', 'locatable']:
                    kind = 'check'
                else:
                    kind = 'list'
